...
![Pasted image 20250912185138.png](../Image/Pasted%20image%2020250912185138.png)
...
![Pasted image 20250912185540.png](../Image/Pasted%20image%2020250912185540.png)

**Step 4 : Switched the login header to admin so as to get the admin panel**
![Pasted image 20250912185800.png](../Image/Pasted%20image%2020250912185800.png)
![Pasted image 20250912185830.png](../Image/Pasted%20image%2020250912185830.png) Got a 404 response, Tried  admin-panel and possible name for the admin webpage 
**Step 5 : Boom Got a 200 response code**
![Pasted image 20250912190425.png](../Image/Pasted%20image%2020250912190425.png)
![Pasted image 20250912190624.png](../Image/Pasted%20image%2020250912190624.png)
...
![Pasted image 20250912190958.png](../Image/Pasted%20image%2020250912190958.png)
...
![Pasted image 20250923004917.png](../Image/Pasted%20image%2020250923004917.png)

**Step 1: I intercepted the request using burp proxy and i went straight to login page.**
![Pasted image 20250923005037.png](../Image/Pasted%20image%2020250923005037.png)
![Pasted image 20250923005151.png](../Image/Pasted%20image%2020250923005151.png)
**Step 2:  Tried to login wasn't meant to login !**
![Pasted image 20250923005323.png](../Image/Pasted%20image%2020250923005323.png)
![Pasted image 20250923005536.png](../Image/Pasted%20image%2020250923005536.png)
...
![Pasted image 20250923005846.png](../Image/Pasted%20image%2020250923005846.png)
**Step 4: Noticed something about the JavaScript code, There had dropped the URL for the admin  page in the code**
![Pasted image 20250923010020.png](../Image/Pasted%20image%2020250923010020.png)
**Step 5: Changed the request to the URL code that was for the admin page Boom I got a 200 response code .**
![Pasted image 20250923010228.png](../Image/Pasted%20image%2020250923010228.png)
**Step 6: I could delete the users !**
![Pasted image 20250923010423.png](../Image/Pasted%20image%2020250923010423.png)
...
![Pasted image 20250923012144.png](../Image/Pasted%20image%2020250923012144.png)
**Step 1: I intercepted the request of the login page**
![Pasted image 20250923012550.png](../Image/Pasted%20image%2020250923012550.png)
**Step2: First thing i noticed is that admin is set to False!**
![Pasted image 20250923012646.png](../Image/Pasted%20image%2020250923012646.png)
**Step3 : Sent the request to Burp Repeater and changed the parameter to True**
![Pasted image 20250923012843.png](../Image/Pasted%20image%2020250923012843.png)
...
![Pasted image 20250923012926.png](../Image/Pasted%20image%2020250923012926.png)
...
![Pasted image 20250923145829.png](../Image/Pasted%20image%2020250923145829.png)
**Step 6: I clicked on the admin panel and i intercepted the request and changed the parameter to true**
![Pasted image 20250923150052.png](../Image/Pasted%20image%2020250923150052.png)
![Pasted image 20250923150123.png](../Image/Pasted%20image%2020250923150123.png)
**Step 7: Forwarded the request and changed the request again and changed the cookie parameter**
![Pasted image 20250923150400.png](../Image/Pasted%20image%2020250923150400.png)
and i was able to delete the users account and Boom
![Pasted image 20250923150536.png](../Image/Pasted%20image%2020250923150536.png)
...
![Pasted image 20250923153817.png](../Image/Pasted%20image%2020250923153817.png)
**Step 1: As you all know start by intercepting the request and when i logged in i was given an API key**
![Pasted image 20250923154403.png](../Image/Pasted%20image%2020250923154403.png)
**Step 2: I logged out to see if there could be any clue**
![Pasted image 20250923155759.png](../Image/Pasted%20image%2020250923155759.png)
...
![Pasted image 20250923161700.png](../Image/Pasted%20image%2020250923161700.png)
