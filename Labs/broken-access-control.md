...
![Login page redirect](/Image/Pasted image 20250912185402.png)
Then i sent the request to Burp Repeater 
![Burp Repeater request](/Image/Pasted image 20250912185540.png)

**Step 4 : Switched the login header to admin so as to get the admin panel**
![Switched to admin header](/Image/Pasted image 20250912185800.png)
![404 response after switch](/Image/Pasted image 20250912185830.png) Got a 404 response, Tried admin-panel and possible name for the admin webpage 

**Step 5 : Boom Got a 200 response code**
![200 response success](/Image/Pasted image 20250912190425.png)
![Admin panel access](/Image/Pasted image 20250912190624.png)
...
![Lab solved congratulations](/Image/Pasted image 20250912190958.png)
...
![Unprotected admin with unpredictable URL](/Image/Pasted image 20250923004917.png)

**Step 1: I intercepted the request using burp proxy and i went straight to login page.**
![Burp proxy intercept to login](/Image/Pasted image 20250923005037.png)
![Login page view](/Image/Pasted image 20250923005151.png)

**Step 2: Tried to login wasn't meant to login**
![Failed login attempt](/Image/Pasted image 20250923005323.png)
![Another login view](/Image/Pasted image 20250923005536.png)
...
![Home page clue search](/Image/Pasted image 20250923005846.png)

**Step 4: Noticed something about the JavaScript code, There had dropped the URL for the admin page in the code**
![JavaScript code with admin URL](/Image/Pasted image 20250923010020.png)

**Step 5: Changed the request to the URL code that was for the admin page Boom I got a 200 response code**
![200 response after URL change](/Image/Pasted image 20250923010228.png)

**Step 6: I could delete the users**
![User deletion success](/Image/Pasted image 20250923010423.png)
...
![User role parameter lab](/Image/Pasted image 20250923012144.png)

**Step 1: I intercepted the request of the login page**
![Login request intercept](/Image/Pasted image 20250923012550.png)

**Step2: First thing i noticed is that admin is set to False**
![Admin parameter false](/Image/Pasted image 20250923012646.png)

**Step3 : Sent the request to Burp Repeater and changed the parameter to True**
![Changed parameter to true](/Image/Pasted image 20250923012843.png)
...
![302 to 200 redirect](/Image/Pasted image 20250923012926.png)
...
![Second intercept and change](/Image/Pasted image 20250923145829.png)

**Step 6: I clicked on the admin panel and i intercepted the request and changed the parameter to true**
![Admin panel request change](/Image/Pasted image 20250923150052.png)
![Another admin view](/Image/Pasted image 20250923150123.png)

**Step 7: Forwarded the request and changed the request again and changed the cookie parameter**
![Cookie parameter change](/Image/Pasted image 20250923150400.png)
and i was able to delete the users account and Boom
![Deletion success](/Image/Pasted image 20250923150536.png)
...
![User ID parameter lab](/Image/Pasted image 20250923153817.png)

**Step 1: As you all know start by intercepting the request and when i logged in i was given an API key**
![API key after login](/Image/Pasted image 20250923154403.png)

**Step 2: I logged out to see if there could be any clue**
![Logout view](/Image/Pasted image 20250923155759.png)
...
![Searching articles for clues](/Image/Pasted image 20250923161700.png)
